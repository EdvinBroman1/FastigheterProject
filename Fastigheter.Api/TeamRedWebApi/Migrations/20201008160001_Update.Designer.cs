...
namespace TeamRedWebApi.Migrations
{
    ...
    [Migration("20201008160001_Update")]
            ...
            modelBuilder.Entity("TeamRedProject.Enitites.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 148, DateTimeKind.Unspecified).AddTicks(676), new TimeSpan(0, 2, 0, 0, 0)),
                            RealEstateId = 1,
                            UserId = 1
                        },
                        new
            ...
            modelBuilder.Entity("TeamRedProject.Enitites.RealEstate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 143, DateTimeKind.Unspecified).AddTicks(5859), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 147, DateTimeKind.Unspecified).AddTicks(7811), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 3,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 147, DateTimeKind.Unspecified).AddTicks(7982), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 4,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 147, DateTimeKind.Unspecified).AddTicks(7996), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 5,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 147, DateTimeKind.Unspecified).AddTicks(8004), new TimeSpan(0, 2, 0, 0, 0)),
                            Address = "Mariaplan 5",
                            CanBePurchased = true,
                            CanBeRented = true,
                        ...
                        {
                            Id = 6,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 147, DateTimeKind.Unspecified).AddTicks(8012), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 7,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 8, 18, 0, 1, 147, DateTimeKind.Unspecified).AddTicks(8020), new TimeSpan(0, 2, 0, 0, 0)),
