...
namespace TeamRedWebApi.Migrations
{
    ...
    [Migration("20201006182831_AddedSeeding")]
            ...
            modelBuilder.Entity("TeamRedProject.Enitites.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(1148), new TimeSpan(0, 2, 0, 0, 0)),
                            RealEstateId = 1,
                            UserId = 1
                        },
                        new
            ...
            modelBuilder.Entity("TeamRedProject.Enitites.RealEstate", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 876, DateTimeKind.Unspecified).AddTicks(550), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 2,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(30), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 3,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(135), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 4,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(144), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 5,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(150), new TimeSpan(0, 2, 0, 0, 0)),
                            Address = "Mariaplan 5",
                            CanBePurchased = true,
                            CanBeRented = true,
                        ...
                        {
                            Id = 6,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(156), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        {
                            Id = 7,
                            AdCreated = new DateTimeOffset(new DateTime(2020, 10, 6, 20, 28, 30, 878, DateTimeKind.Unspecified).AddTicks(162), new TimeSpan(0, 2, 0, 0, 0)),
